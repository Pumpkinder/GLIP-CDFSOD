...
sed -i "s/${SHOT}_shot_pseu.json/${SHOT}_shot.json/g" ${DIR}/configs/cdfsod/dataset2.yaml ##有需要则测试文件修改为训练文件用于打伪标签
sed -i "s/${SHOT}_shot.json/00tmpp/g" ${DIR}/configs/cdfsod/dataset2_train.yaml ##有需要则测试文件修改为训练文件用于打伪标签


######################## zero shot打标签
sed -i "s/00tmpp/${SHOT}_shot.json/g" ${DIR}/configs/cdfsod/dataset2_train.yaml ##有需要则测试文件修改为训练文件用于打伪标签
...
sed -i "s/${SHOT}_shot.json/${SHOT}_shot_pseu.json/g" ${DIR}/configs/cdfsod/dataset2.yaml ##有需要则测试文件修改为训练文件用于打伪标签
